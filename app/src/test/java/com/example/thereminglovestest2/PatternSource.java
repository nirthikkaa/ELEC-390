 ...
 *
 * Production playback is handled directly inside DrumEngine. The unit tests still verify the
 * older row-routing behavior in isolation, so this interface keeps that contract available
 * without pulling Android-specific classes into the test logic.
 */
